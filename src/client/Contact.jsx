...
const allLocations = ['', 'Arlington', 'Auburndale', 'Belmont', 'Cambridge (Alewife)', 'Lexington', 'Medford', 'Newton Corner', 'Newtonville (Com Av towards Watertown only)', 'Nonantum', 'Waltham', 'Watertown', 'West Newton', 'Winchester']
function Contact() {
    return (
        <div className="container justify-content-evenly">
            ...
            <form style={{paddingBottom: "2rem"}}>
                ...
                <input type="phone" className="form-control mb-3" placeholder="Your Phone Number" required />
